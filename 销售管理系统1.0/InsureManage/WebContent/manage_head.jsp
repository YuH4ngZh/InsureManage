...
<body>
	...
	<table frame="below" width=100% style="font-size:20px">
		<tr>
			<th bgcolor="#66ccff" align="center" width=22%>后台管理</th>
			<td align="center" width=13%><a href="index.jsp">首页</a></td>
			<td align="center" width=13%><a href="manage_operation.jsp"> 用户登录日志</a></td>
			<td align="center" width=13%><a href="manage_config.jsp">产品参数配置</a></td>
			<td align="center" width=13%><a href="manage_buyer.jsp">查看产品销量</a></td>
			<td align="center" width=13%><a href="manage_user.jsp">用户信息管理</a></td>
			<td align="center" width=13%><a href="manage_worker.jsp">业务人员管理</a></td>
		</tr>
	</table>
</body>
</html>